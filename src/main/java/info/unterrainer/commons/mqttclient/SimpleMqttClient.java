...
public class SimpleMqttClient {
	...
	public SimpleMqttClient(final String mqttServerAddress, final JsonMapper jsonMapper) {
		this(mqttServerAddress, jsonMapper, MqttQos.AT_LEAST_ONCE, false);
	}

	public SimpleMqttClient(final String mqttServerAddress, final JsonMapper jsonMapper, final boolean retainOnServer) {
		this(mqttServerAddress, jsonMapper, MqttQos.AT_LEAST_ONCE, retainOnServer);
	}

	public SimpleMqttClient(final String mqttServerAddress, final JsonMapper jsonMapper, final MqttQos qos) {
		this(mqttServerAddress, jsonMapper, qos, false);
	}
	...
	public SimpleMqttClient(final String mqttServerAddress, final JsonMapper jsonMapper, final MqttQos qos,
		...
		try {
			client = new MqttClient(this.mqttServerAddress, clientId);
